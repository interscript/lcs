= ARCHIVED: Interscript LCS

WARNING: This work has already been merged into the main interscript/interscript repository
with Git history preserved. This repository is now read-only.
